...
def is_user_authenticated(get_response):
    ...
    def middleware(request):
        ...
        if "authenticate" not in request.path:
            ...
            #Proceed loading the page if one of the public URLs is requested
            ...
            # to what the login function handles, but before that happens we must
            ...
            # Otherwise user will be redirected to /authenticate page
            if not request.code:
